(() => {
  ...
  const I18N = {
    ...
    en: {
      ...
      checkingCloudName: 'Checking nickname availability...',
      ...
      scoreNotHigher: 'This nickname already has an equal or higher score ({score}). It cannot be replaced by this run.',
      scoreNotHigherNoValue: 'This nickname already has an equal or higher score. This run cannot overwrite it.',
      recordWillReplace: 'This nickname already has a record. Your new score {newScore} will replace {oldScore}.',
      ...
      hintReleaseMiracle: 'If it feels too hard, try lifting your finger for a moment — a miracle might happen',
    ...
    ja: {
      ...
      leaderboardEmpty: 'まだ記録がありません。まずは1回プレイして保存してください。',
